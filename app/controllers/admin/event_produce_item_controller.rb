class Admin::EventProduceItemController < Admin::BaseController
  ...
  def create
    ...
    if event_produce_item.save
      redirect_to admin_page_path(event_produce_item.page, tab: "produce"), notice: "Event Produce Item Successfully Created"
    end
  end
  ...
  def update
    ...
    if @event_produce_item.save
      redirect_to edit_admin_event_produce_item_path(@event_produce_item, tab: "produce"), notice: "Event Produce Item Successfully Updated"
    end
  end

  def destroy
    if @event_produce_item.destroy
      redirect_to admin_page_path(@event_produce_item.page, tab: "produce"), alert: "Event Produce Item Deleted Successfully"
    end
  end
